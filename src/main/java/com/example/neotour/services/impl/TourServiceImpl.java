...
//                                build().
//                                toUriString() + "/api/v1/images/" + tour.getImage().getImageId())).toList();
//    }

//    @Override
//    public Tour addTour(String tourName, String tourDescription, MultipartFile image) {
//        Tour tour = new Tour();
//        tour.setTourName(tourName);
//        tour.setTourDescription(tourDescription);
//        tour.setImage(ImageUtils.compressImage(image));
...
//    }
    ...
    @Override
    public Tour addTour(String tourName, String tourDescription, String tourLocation, MultipartFile image)  {
        Tour tour = new Tour();
        tour.setTourName(tourName);
        tour.setTourDescription(tourDescription);
